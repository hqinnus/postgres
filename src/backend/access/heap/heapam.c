...
static void BlockSampler_Init(BernoulliSampler bs, BlockNumber nblocks,
				  int samplesize);
 ...
 */
static void
BlockSampler_Init(BernoulliSampler bs, BlockNumber nblocks, int samplesize)
{
...
static bool
BlockSampler_HasMore(BernoulliSampler bs)
{
	return (bs->t < bs->N) && (bs->m < bs->n);
}

static BlockNumber
BlockSampler_Next(BernoulliSampler bs)
{
...
/*
 * acquire_next_sampletup -- modified from acquire_sample_rows from analyze.c
 *
